...
public class Test {
    ...
    private static Semaphore Sem3 = new Semaphore(2);
    private static Semaphore Sem4 = new Semaphore(2);
    private static AtomicLong a = new AtomicLong(0);

		// Initialize your data (MD, MB, MA, C, E, d)
    ...
    private static void T1() {
        ...
        try {
            ...
            long[][] result1 = matrixMultiplication(MA, MB, H*(p-1), H*p);
						...
						long[] result3 = multiplyVectorByScalar(result2, d1, 0, 0);
						// System.out.println("E*(MA*MB)*d " + Arrays.toString(result3));
						Sem2.release();
						Sem3.acquire();
						long[] result4 = multiplyVectorByScalar(C, a1, H*(p-1), H*p);
						// System.out.println("a*C " + Arrays.toString(result4));
						Sem3.release();
						setValues(W, vectorAddition(result4, result3), H*(p-1), H*p);
    ...
    private static void T2() {
        ...
        try {
            ...
            long[][] result1 = matrixMultiplication(MA, MB, H*(p-1), H*p);
						...
						long[] result2 = scalarVectorMultiplication(E, result1, 0, 0);
						// System.out.println("E*(MA*MB) " + Arrays.toString(result2));
						long[] result3 = multiplyVectorByScalar(result2, d2, 0, 0);
						// System.out.println("E*(MA*MB)*d " + Arrays.toString(result3));
						long[] result4 = multiplyVectorByScalar(C, a2, H*(p-1), H*p);
						// System.out.println("a*C " + Arrays.toString(result4));
						setValues(W, vectorAddition(result4, result3), H*(p-1), H*p);
						// System.out.println("W1 = " + Arrays.toString(W));
    ...
    private static void T3() {
        ...
        try {
            ...
            long[][] result1 = matrixMultiplication(MA, MB, H*(p-1), H*p);
						...
						long[] result2 = scalarVectorMultiplication(E, result1, 0, 0);
						// System.out.println("E*(MA*MB) " + Arrays.toString(result2));
						long[] result3 = multiplyVectorByScalar(result2, d3, 0, 0);
						// System.out.println("E*(MA*MB)*d " + Arrays.toString(result3));
						long[] result4 = multiplyVectorByScalar(C, a3, H*(p-1), H*p);
						// System.out.println("a*C " + Arrays.toString(result4));
						setValues(W, vectorAddition(result4, result3), H*(p-1), H*p);
						// System.out.println("W1 = " + Arrays.toString(W));
    ...
    private static void T4() {
        ...
        try {
            ...
            long[][] result1 = matrixMultiplication(MA, MB, H*(p-1), H*p);
						...
						long[] result2 = scalarVectorMultiplication(E, result1, 0, 0);
						// System.out.println("E*(MA*MB) " + Arrays.toString(result2));
						long[] result3 = multiplyVectorByScalar(result2, d4, 0, 0);
						// System.out.println("E*(MA*MB)*d " + Arrays.toString(result3));
						long[] result4 = multiplyVectorByScalar(C, a4, H*(p-1), H*p);
						// System.out.println("a*C " + Arrays.toString(result4));
						setValues(W, vectorAddition(result4, result3), H*(p-1), H*p);
						// System.out.println("W1 = " + Arrays.toString(W));
