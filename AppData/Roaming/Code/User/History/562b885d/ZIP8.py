...
sortedPetal = np.sort(petal)
stat1 = np.min(petal)
stat2 = np.max(petal)
stat3 = np.mean(petal)
stat4 = np.var(petal)
stat5 = np.std(petal)
stat6 = np.median(petal)
stat7 = np.percentile(petal, [25, 75])
print("\nВирахунок статистичних характеристик:")
print(f"sorted initial data = \n{sortedPetal}")
print(f"min = {stat1}")
print(f"max = {stat2}")
print(f"mean = {stat3}")
print(f"var = {stat4}")
print(f"std = {stat5}")
print(f"median = {stat6}")
print(f"percentile(25,75) = {stat7}")


print(randArr3[0:5:2,1:4])