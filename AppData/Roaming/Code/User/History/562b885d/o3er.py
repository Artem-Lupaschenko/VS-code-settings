...
data = pd.read_csv("D:\Univer (labs)\AD Python\LR1\iris.csv")
...
print("Генерація невипадкових масивів різними способами\n")
print(arr1)
print(arr2)
print(arr3)
print(arr4)
...
print("Генерація випадкових масивів різними способами\n")
print(randArr1)
print(randArr2)
print(randArr3)
print(randArr4)
