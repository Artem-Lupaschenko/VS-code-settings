...
print(f'Неправильні дані: {data[data.MeanTemp.isna() | data.Humidity.isna() | data.WindSpeed.isna() | data.MeanPressure.isna()]}')
data.WindSpeed.fillna(data.WindSpeed.rolling(7, min_periods=3).median(), inplace=True)
data.dropna(inplace=True)
print(data.loc['2013-08-05':'2013-08-16'])
print(f'Неправильні дані: {data[data.MeanTemp.isna() | data.Humidity.isna() | data.WindSpeed.isna() | data.MeanPressure.isna()]}')
data.info()
